...
public class Fundament_codes {
	...
	public void num_rev() {
		...
		if (b == i) {
			System.out.println("palendrom " + "original no " + i
					+ " reverse no ->>" + b);
		} else {
			System.out.println("not palendrom " + "original no " + i
					+ " reverse no ->>" + b);
		}
	}
	...
	public void Factorial() {
		...
		System.out.println("enter the no to be factorial");
		a = sc.nextInt();
		temp=1;
		for (i=a; i>0; i--)
			temp = temp*i;
		     
			 System.out.println("factroial is ->>" + temp);
	}
